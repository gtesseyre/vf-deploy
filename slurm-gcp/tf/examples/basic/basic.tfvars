...
network_name            = "vf-network"
subnetwork_name         = "vf-west-subnet"
...
network_storage = [{
  server_ip     = "10.102.14.42"
  remote_mount  = "/virtualflow"
  local_mount   = "/mnt/virtualflow"
  fs_type       = "nfs"
